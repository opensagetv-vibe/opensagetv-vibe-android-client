...
public class MediaMappingsFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener
{
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey)
    {
        ...
        SwitchPreferenceCompat spSmartRemote;
        ListPreference lp;

        setPreferencesFromResource(R.xml.media_mappings_prefs, rootKey);
        ...
        */
        ...
        spSmartRemote = (SwitchPreferenceCompat)this.findPreference("smart_remote_mappings");
