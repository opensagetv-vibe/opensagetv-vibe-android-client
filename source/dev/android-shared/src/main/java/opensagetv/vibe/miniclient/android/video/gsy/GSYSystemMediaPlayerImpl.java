...
public final class GSYSystemMediaPlayerImpl extends BaseMediaPlayerImpl<MediaPlayer, MediaDataSource>
{
    ...
    {
        void onSystemPlayerFailed(GSYSystemMediaPlayerImpl failedPlayer);
    }
    ...
    public GSYSystemMediaPlayerImpl(AndroidUIController activity, FailureListener failureListener)
    {
    ...
    protected void playerFailed()
    {
        ...
        eos = true;
        releasePlayer();
        failureListener.onSystemPlayerFailed(this);
    }
