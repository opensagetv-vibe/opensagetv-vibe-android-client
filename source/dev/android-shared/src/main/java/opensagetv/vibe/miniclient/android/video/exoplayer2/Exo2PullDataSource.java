...
public class Exo2PullDataSource implements DataSource, HasClose, SessionOwnedDataSource, PlaybackDataSourceTelemetry
{
    ...
    // The immutable player configuration injects the proven 512 KiB default.
    ...
    public Exo2PullDataSource(String host, boolean potentiallyGrowing, SmbDirectConfig smbConfig)
    {
        this(host, potentiallyGrowing, smbConfig, PlayerRuntimeTuning.getExo2PullReadBytes());
    }
