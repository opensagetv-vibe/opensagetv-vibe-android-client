...
public class AutoConnectDialog extends DialogFragment {
    ...
    public AutoConnectDialog() {
        setStyle(DialogFragment.STYLE_NO_TITLE, androidx.appcompat.R.style.Theme_AppCompat_Dialog);
        setStyle(DialogFragment.STYLE_NO_FRAME, androidx.appcompat.R.style.Theme_AppCompat_Dialog);
    }
