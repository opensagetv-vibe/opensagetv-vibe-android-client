...
import opensagetv.vibe.miniclient.android.preferences.TouchPreferences;

public class TouchMappingsFragment extends PreferenceFragmentCompat {
    //PrefStore prefs
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        ListPreference lp;
        setPreferencesFromResource(R.xml.touch_mappings_prefs, rootKey);
