...
public class ServerItemPresenter extends Presenter
{
    ...
    class ServerViewHolder extends ViewHolder {
        ...
        public void bind(ServerInfo si) {
            ...
            if (si.isLocatorOnly()) {
                icon.setImageResource(sagex.miniclient.android.R.drawable.ic_add_to_queue_white_60dp);
            } else {
                icon.setImageResource(sagex.miniclient.android.R.drawable.ic_tv_white_60dp);
            }
        }
    }
