...
public class ServersAdapter extends RecyclerView.Adapter<ServersAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener, PopupMenu.OnMenuItemClickListener {
        ...
        public ViewHolder(View v) {
            ...
            v.setBackgroundResource(sagex.miniclient.android.R.drawable.iconbutton_background);
        }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (si.isLocatorOnly()) {
            holder.icon.setImageResource(sagex.miniclient.android.R.drawable.ic_add_to_queue_white_60dp);
        } else {
            holder.icon.setImageResource(sagex.miniclient.android.R.drawable.ic_tv_white_60dp);
        }
