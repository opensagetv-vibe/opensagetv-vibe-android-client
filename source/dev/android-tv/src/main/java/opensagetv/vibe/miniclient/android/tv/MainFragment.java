...
import opensagetv.vibe.miniclient.android.tv.actions.Action;
import opensagetv.vibe.miniclient.android.tv.actions.ActionPresenter;
import opensagetv.vibe.miniclient.android.util.ServerInfoUtil;
import opensagetv.vibe.miniclient.android.util.ServerInfoUtil.OnAfterCommands;

public class MainFragment extends BrowseSupportFragment implements OnAddServerListener {
    ...
    private final Runnable mBackgroundUpdater = new Runnable() {
        @Override
        public void run() {
    ...
    public void onDestroy() {
        super.onDestroy();
        mHandler.removeCallbacks(mBackgroundUpdater);
    ...
    private void setupUIElements() {
        setBadgeDrawable(getActivity().getResources().getDrawable(
                opensagetv.vibe.miniclient.android.R.drawable.sage_logo_256));
    ...
    private void startBackgroundTimer() {
        mHandler.removeCallbacks(mBackgroundUpdater);
        mHandler.postDelayed(mBackgroundUpdater, BACKGROUND_UPDATE_DELAY);
    }
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            else if (item instanceof Action)
            {
                ...
                else if (action.getActionId() == R.id.btn_add_server)
                {
                    ...
                    f.show(getParentFragmentManager(), "addserver");
                }
                else
                {
