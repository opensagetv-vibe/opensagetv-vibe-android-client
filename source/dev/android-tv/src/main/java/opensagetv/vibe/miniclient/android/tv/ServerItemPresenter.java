...
public class ServerItemPresenter extends Presenter
{
    ...
    class ServerViewHolder extends ViewHolder {
        ...
        public void bind(ServerInfo si) {
            ...
            if (!opensagetv.vibe.miniclient.util.Utils.isEmpty(si.address)) {
            ...
            if (!opensagetv.vibe.miniclient.util.Utils.isEmpty(si.locatorID)) {
            ...
            if (si.isLocatorOnly()) {
                icon.setImageResource(opensagetv.vibe.miniclient.android.R.drawable.ic_add_to_queue_white_60dp);
            } else {
                icon.setImageResource(opensagetv.vibe.miniclient.android.R.drawable.ic_tv_white_60dp);
            }
        }
    }
