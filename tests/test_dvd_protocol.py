...
class DvdProtocolTests(unittest.TestCase):
    ...
    def test_hdmi_validation_capture_requires_video_and_audio_devices(self):
        ...
        self.assertIn("VIBE_FFMPEG_PATH", capture)
        self.assertIn('"-f",\n        "dshow"', capture)
        self.assertIn('"-video_size",\n        "1920x1080"', capture)
        self.assertIn('"-vcodec",\n        "mjpeg"', capture)
        self.assertIn('"-c:v",\n        "libx264"', capture)
        self.assertIn('"-framerate",\n        "30"', capture)
        self.assertIn('"-c:a",\n        "aac"', capture)
        self.assertNotIn("VIBE_VLC_PATH", capture)
        self.assertNotIn("vlc.exe", capture.lower())
