...
class MCPPlaybackAutomationTests(unittest.TestCase):
    ...
    def test_session_control_connect_ui_start_and_exit_tools(self):
        ...
        self.assertNotIn('"watch_server_file".equals(op)', receiver)
        self.assertNotIn('"set_live_channel".equals(op)', receiver)
        ...
        self.assertNotIn('postVibeWatchFileEvent(', session_commands)
        self.assertNotIn('postVibeChannelSetEvent(channel)', session_commands)
        self.assertNotIn('VIBE_WATCH_FILE_EVENT_REPLY_TYPE = 230', connection)
        self.assertNotIn('VIBE_CHANNEL_SET_EVENT_REPLY_TYPE = 231', connection)
        self.assertNotIn('VIBE_WATCH_FILE_FROM_BEGINNING_EVENT_REPLY_TYPE = 232', connection)
        self.assertNotIn('VIBE_SEEK_EVENT_REPLY_TYPE = 233', connection)
        ...
        self.assertNotIn('public boolean postVibeWatchFileEvent(String serverPath)', connection)
        self.assertNotIn('public boolean postVibeSeekEvent(final long targetMs)', connection)
        self.assertNotIn('DebugSessionCommands.seekServerTime(context, intent)', receiver)
        self.assertNotIn('postVibeSeekEvent(targetMs)', session_commands)
        ...
        self.assertIn('Exact server-path playback requires the stock-compatible Vibe Core MCP plugin', server)
        self.assertIn('sage_control.resolve_exact_path(requested)', server)
        ...
        self.assertIn('stopped_state.get("health_isPlaying") is False', server)
        self.assertIn('stopped_state.get("health_playWhenReady") is False', server)
