...
class RefactorTests(unittest.TestCase):
    def make_tree(self, root: Path) -> None:
        ...
        (root / "android-shared/src/main/java/opensagetv/vibe/miniclient/android").mkdir(parents=True)
        ...
        (root / "android-shared/src/main/java/opensagetv/vibe/miniclient/android/MiniclientApplication.java").write_text(APP_JAVA)
    ...
    def test_refactor_isolated_identity_and_firebase_removal(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertIn('applicationId "opensagetv.vibe.miniclient"', all_text)
            self.assertIn("OpenSageTV Vibe", all_text)
